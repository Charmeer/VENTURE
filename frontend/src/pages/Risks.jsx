  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-12">
        <h1 className="section-title">{riskData.title}</h1>
        <p className="section-subtitle">{riskData.description}</p>
      </div>
      ...
      <div className="mb-16">
        ...
        <div className="space-y-6">
          {riskData.risks.map((risk) => (
            <div 
              key={risk.id} 
              className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden transition-all duration-300 hover:shadow-xl card"
            >
              {/* Risk Header */}
              <div 
              ...
              {expandedRisk === risk.id && (
                <div className="px-6 pb-6 bg-gray-50">
                  <div className="grid md:grid-cols-2 gap-6 pt-4">
                    {/* Risk Description */}
                    <div className="bg-white rounded-lg p-5 shadow-sm border border-gray-100 card">
        ...
        <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl p-8">
          <div className="grid md:grid-cols-2 gap-6">
            {riskData.contingencyPlans.map((plan, index) => (
              <div 
                key={index} 
                className="flex items-start p-4 bg-white rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow card"
              >
