  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-12">
        <h1 className="section-title">{operationsData.title}</h1>
        <p className="section-subtitle">{operationsData.description}</p>
      </div>
      ...
      <div className="mb-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Feedstock Handling */}
          <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200 card">
